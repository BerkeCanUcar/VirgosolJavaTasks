// Farklı tip girdileri tek satırda birleştirerek yazma
...
public class tip {
    ...
    public static void main(String[] args){
        ...
        System.out.print("Benim adım " + isim + ", yaşım " + yas + " boyum " + boy + " metre ve cebimde " + para + " TL para var.");
...
Benim adım Ali, yaşım 23, boyum 1.86 metre ve cebimde 25680.0 TL para var.
